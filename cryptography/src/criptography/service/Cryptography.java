 ...
 *
 */
public class Cryptography implements CryptographyRepository {
	...
	public char characterLimitAdjust(char character, int steps) {
		if ((int) character >= 65 && (int) character <= 90) {
			return ((int) character + steps > 90) ? (char) ((char) (character - 26)) : character;
		}

		return ((int) character + steps > 122) ? (char) ((char) (character - 26)) : character;
	}
}
